...
@section("content")
    <a href="{{route('shopcon.add')}}" class="btn btn-success">添加</a>
    ...
    <table class="table table-bordered table-hover">
        ...
        @foreach($shopcontents as $shopcontent)
            <tr>
                ...
                <td>
                    <a href="{{route('shopcon.edit',$shopcontent)}}" class="btn btn-primary">编辑</a>
                    <a href="{{route('shopcon.del',$shopcontent)}}" class="btn btn-danger">删除</a>
                </td>
            </tr>
        @endforeach
    </table>
